...
<div class="landing-root">
	...
	<nav class="landing-nav">
		<div class="nav-left">
			...
			<div class="nav-links">
				<a class="nav-link nav-link--active" href="/landing">Markets</a>
				<a class="nav-link" href="/landing">News</a>
				<a class="nav-link" href="/landing">Watchlist</a>
			</div>
		</div>
		<div class="nav-right">
			...
			<div class="hero-grid">
				<div class="hero-text">
					...
					<div class="hero-buttons">
						<a href="/" class="btn-primary-green">Start Analyzing</a>

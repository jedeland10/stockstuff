<script lang="ts">
  ...
  const allCols: ColDef[] = [
    ...
    { key: 'perf_1w', label: '1w', width: '58px', align: 'right',
      render: (s) => fmtPct(s.perf_1w), cellClass: (s) => pctClass(s.perf_1w) },
    { key: 'perf_1m', label: '1m', width: '58px', align: 'right',
      render: (s) => fmtPct(s.perf_1m), cellClass: (s) => pctClass(s.perf_1m) },
    ...
    { key: 'div_yield', label: 'Div', width: '48px', align: 'right',
      render: (s) => s.div_yield != null ? s.div_yield.toFixed(1) + '%' : '\u2014', cellClass: (s) => s.div_yield != null && s.div_yield > 0 ? 'num text-positive' : 'num' },
    ...
    { key: 'roe', label: 'ROE', width: '48px', align: 'right',
      render: (s) => s.roe != null ? s.roe.toFixed(0) + '%' : '\u2014', cellClass: (s) => pctClass(s.roe) },
    { key: 'margin', label: 'Mrgn', width: '52px', align: 'right',
      render: (s) => s.margin != null ? s.margin.toFixed(0) + '%' : '\u2014', cellClass: (s) => pctClass(s.margin) },
